<template>
  <BasicDrawer v-bind="$attrs" @register="registerDrawer" showFooter width="600px" :title="getTitle"
               @ok="handleSubmit">
...
import { saveOrUpdateMenu, listTree } from "./menu.api";
// 声明Emits
...
function filterMenu(treeData, menuId) {
  ...
  if (treeData.children && treeData.children.length > 0) {
    filterDept(treeData.children, menuId);
  }
}
