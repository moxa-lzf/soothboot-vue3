...
import{listAll as listBaseClassAll}from '/@/views/generate/base-class/baseClass.api'
...
export const genTableColumns: BasicColumn[] = [
  ...
  },
  {
    ...
    dataIndex: 'primaryPk',
    customRender:(opt)=>{
      return h(Checkbox,{checked:opt.record.primaryPk,["onUpdate:checked"]:(checked)=>{
